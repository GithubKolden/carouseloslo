...
const ProductDetails = ({ product }) => {
  ...
  /*-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
  return (
    <NoSsr> {/* wrap the component in NoSsr */}
      <Container style={{ marginTop: "50px", color: "#494949", maxWidth: "525px", maxHeight: "40vh", justifyContent: "center", alignItems: "center"}}>
        <Box>
            <Carousel>
                {
          ...
          <div>
            ...
            <h1>{name}</h1>
            <p style={{paddingTop: "15px", paddingBottom: "25px"}}>{details}</p>
